...
export const nunito = Nunito({ subsets: ["latin-ext"], weight: ['200', '300', '400', '500', '600', '700', '800'] });
...
export const raleway = Raleway({ subsets: ['latin-ext'], weight: ['100', '200', '300', '400', "500"]})
