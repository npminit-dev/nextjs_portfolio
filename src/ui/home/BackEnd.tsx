...
export default function BackEnd() {
  ...
  return (
    <article className="h-fit min-h-96 w-screen bg-purple-200 dark:bg-purple-900">
      <span className="relative h-[100%] w-[100%] opacity-0" ref={ref}>
        <div className="relative grid h-[500px] md:h-[400px] w-[100%] grid-cols-none grid-rows-2 items-center justify-center md:grid-cols-2 md:grid-rows-none overflow-hidden">
          ...
          <div className="relative order-1 md:order-2 h-[100%] w-[100%] flex items-center justify-center bg-gradient-to-tl from-purple-200 to-purple-100 dark:from-purple-900 dark:to-purple-800 self-center justify-self-center">
