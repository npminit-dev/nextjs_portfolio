...
export default function Databases() {
  ...
  return (
    <article className="h-fit min-h-96 w-screen bg-green-300">
      <span className="relative h-[100%] w-[100%] opacity-0" ref={ref}>
        <div className="relative grid h-[500px] md:h-[400px] w-[100%] grid-cols-none grid-rows-2 items-center justify-center md:grid-cols-2 md:grid-rows-none overflow-hidden">
          ...
          <div className="relative order-1 md:order-1 h-[100%] w-[100%] flex items-center justify-center bg-gradient-to-tl from-green-300 to-green-200 self-center justify-self-center">
            <div className="absolute h-[100%] w-[500px]">
              ...
              <SiMongodb className="absolute h-[60px] w-[60px] md:h-[110px] md:w-[110px] m-auto left-[32%] bottom-12 md:left-[20%] md:bottom-[20%] z-[25] text-green-500 hover:scale-105 duration-300" />
