...
export default function Presentation() {
  return (
    <article className={`px-2 py-2 w-full ${nunito.className} relative antialiased leading-tight py-2 md:px-8 md:py-8 z-30 flex flex-col items-center justify-between`}>
      <h2 className="w-[100%] my-2 font-bold md:my-4 text-xl md:text-2xl text-center leading-tight md:leading-normal">A little about me...</h2>
      <p className="my-2 text-sm text-center md:my-3 md:max-w-[1000px] md:text-base leading-tight md:leading-normal">
