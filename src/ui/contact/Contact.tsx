...
export default function Contact({ title, url, description, children }: ContactType) {
  return (
    <div id="Contact-box" onClick={linkOnNewTab(url)} className={`relative h-fit w-full sm:w-fit p-4 m-1 md:m-4 border-[1px] border-slate-500 rounded-s-xl rounded-e-xl overflow-hidden bg-blue-100/75 cursor-pointer z-20 duration-200 hover:scale-[101%] ${nunito.className}`}>
